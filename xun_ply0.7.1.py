...
class VideoPlayer(tk.Tk):
    def __init__(self, folder):
        ...
        self.play_button = tk.Button(self, text="播放", command=self.play_video)
        self.play_button.pack()
        
        self.resolution_label = tk.Label(self, text="选择分辨率:")
        ...
        self.speed = 1.0  # 新增：播放速度，默认为1.0即正常速度
        self.speed_label = tk.Label(self, text="播放速度: 1.0x")
        self.speed_label.pack()
        self.speed_var = tk.DoubleVar(value=1.0)
        self.speed_slider = ttk.Scale(self, orient='horizontal', length=640, from_=0.25, to=10.0, value=1.0, command=self.change_speed)
    ...
    def change_speed(self, value):
        ...
        self.speed_label.config(text=f"播放速度: {self.speed:.1fx}")
    ...
    def play(self):
        ...
        while not self.stop_flag.is_set():
            ...
            while cap.isOpened() and not self.stop_flag.is_set():
                ...
                self.canvas.imgtk = imgtk  # 避免垃圾回收
