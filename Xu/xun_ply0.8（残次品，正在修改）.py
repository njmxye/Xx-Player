...
class VideoPlayer(tk.Tk):
    def __init__(self, folder):
        ...
        self.speed_label = tk.Label(self, text="Playback Speed: 1.0x")
        self.speed_label.pack()
        self.speed_var = tk.DoubleVar(value=1.0)
        self.speed_slider = ttk.Scale(self, orient='horizontal', length=640, from_=0.25, to=4.0, value=1.0, command=self.change_speed)
    ...
    def change_speed(self, value):
        ...
        self.speed_label.config(text=f"Playback Speed: {self.speed:.1fx}")
