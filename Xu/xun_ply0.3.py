...
class VideoPlayer(tk.Tk):
    def __init__(self, folder):
        ...
        self.loading_progress = ttk.Progressbar(self, orient='horizontal', length=640, mode='determinate')
    ...
    def calculate_durations(self):
        self.loading_progress['maximum'] = len(self.video_files)
        ...
        self.progress['to'] = self.total_duration
